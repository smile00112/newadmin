...
use App\Models\Analytics\AnalyticsDailyKpi;
use Illuminate\Support\Facades\DB;

/**
 * Daily KPI aggregation job.
 * Run via: php artisan analytics:aggregate-daily
 *
 * Pre-computes metrics into analytics_daily_kpi for fast dashboard loading.
 */
class DailyKpiAggregator extends BaseAnalyticsService
{
    ...
    /**
     * Aggregate yesterday's data across all channels.
     */
