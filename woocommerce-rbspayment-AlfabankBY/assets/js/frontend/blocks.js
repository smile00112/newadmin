...
const settings = (0,_woocommerce_settings__WEBPACK_IMPORTED_MODULE_4__.getSetting)('alfabankby_data', {});
const defaultLabel = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('RBSPaymentAlfabankBY Payments', 'woo-gutenberg-products-block');
...
const logoUrl = window.alfabankby_data?.logo_url || '';

/**
 * RBSPaymentAlfabankBY payment method config object.
 */
const RBSPaymentAlfabankBY = {
  name: "alfabankby",
...
(0,_woocommerce_blocks_registry__WEBPACK_IMPORTED_MODULE_2__.registerPaymentMethod)(RBSPaymentAlfabankBY);
})();
