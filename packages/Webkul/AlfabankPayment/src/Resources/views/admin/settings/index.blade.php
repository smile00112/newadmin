<x-admin::layouts>
    ...
    <v-alfabank-payment-settings></v-alfabank-payment-settings>
    ...
    @push('scripts')
        <script type="text/x-template" id="v-alfabank-payment-settings-template">
            <div>
                ...
                >
                    <form
                        @submit.prevent="handleSubmit($event, updateSettings)"
                    >
            ...
            app.component('v-alfabank-payment-settings', {
                ...
                methods: {
                    updateSettings(params, { setErrors }) {
                        ...
                        this.$axios.put("{{ route('admin.alfabank.settings.update') }}", payload)
                            .then((response) => {
