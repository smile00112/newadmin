...
return [
    ...
    'sales' => [
        'orders' => [
            ...
            'view' => [
                ...
                'status-history-by'              => 'By: :user',
                'status-history-initial'         => 'Initial status',
                'status-history-admin'           => 'Administrator',
                'status-history-customer'        => 'Customer',
                'status-history-source-system'   => 'System',
    ...
    'catalog' => [
        'products' => [
            ...
            'edit' => [
                ...
                'types' => [
                    ...
                    'constructor' => [
                        'add-btn'                    => 'Add Constructor',
                        'cancel-btn'                 => 'Cancel',
                        'checked-type'               => 'Selection Type',
                        'checked-type-multiple'      => 'Multiple',
                        'checked-type-once'          => 'Single',
                        'combo'                      => 'Combo',
                        ...
                        'design'                     => 'Design',
                        'design-category'            => 'Category - Product',
                        'design-line'                => 'Line',
                        'design-table'               => 'Table',
                        'discount'                   => 'Discount',
                        ...
                        'edit-btn'                   => 'Edit',
                        'edit-constructor'           => 'Edit Constructor',
                        'edit-group-btn'             => 'Edit Group',
                        'empty-info'                 => 'To create product constructor options on a go.',
                        'empty-title'                => 'Add Constructor',
                        ...
                        'template-loaded'            => 'Template data loaded',
                        'save-as-template'           => 'Save as Template',
                        'template-saved-successfully' => 'Template saved successfully',
                        'template-name-required'     => 'Group name is required',
                        'confirm-delete-product'     => 'Are you sure you want to remove this product from the group?',
                        'group'                      => 'Group',
                        'groups'                     => 'Groups',
                        ...
                        'hidden'                     => 'Hidden',
                        'info'                       => 'A constructor product allows customers to build custom products by selecting from predefined groups of ingredients or components.',
                        'min-selected-sum'           => 'Min Selected Sum',
                        'no-groups'                  => 'No groups added yet',
                        'no-products'                => 'No products added yet',
                        'opened-by-default'          => 'Opened by Default',
                        ...
                        'double-portions'             => 'Double Portions',
                        'half-portions'               => 'Half Portions',
                        'incompatibility-template'    => 'Incompatibility Template',
                        'sale-by-sizes'               => 'Sell by sizes',
                        'portion-sizes'               => 'Portion sizes',
                        'add-portion-size'            => 'Add size',
                        'edit-portion-size'           => 'Edit size',
                        'save-size-btn'               => 'Save size',
                        'edit-size'                   => 'Edit',
                        'delete-size'                 => 'Delete',
                        'no-portion-sizes'            => 'No portion sizes added yet',
                        'portion-name'                => 'Name',
                        'portion-name-required'       => 'Portion size name is required',
        ...
        'ingredient-compatibility' => [
            ...
            'create' => [
                'title'       => 'Create Compatibility Template',
                'back-btn'    => 'Back',
                ...
                'description' => 'Description',
                'active'      => 'Active',
                'success'     => 'Compatibility template created successfully',
            ],

            'edit' => [
                'title'                    => 'Edit Compatibility Template',
                'back-btn'                 => 'Back',
                'save-btn'                 => 'Save Template',
                'general'                  => 'General Information',
                'name'                     => 'Template Name',
                ...
                'add-incompatibility'      => 'Add Incompatibility',
                'parent-ingredient'        => 'Parent Ingredient',
                'incompatible-ingredient'  => 'Incompatible Ingredient',
                'incompatible-ingredients' => 'Incompatible Ingredients',
                'search-ingredient'        => 'Search ingredient by SKU or name...',
                'no-incompatibilities'     => 'No incompatibilities added yet',
                'add-product'              => 'Add Product',
                'no-products'              => 'No products added',
                'success'                  => 'Compatibility template updated successfully',
            ],

            'delete' => [
                'success'      => 'Compatibility template deleted successfully',
                'error'        => 'Cannot delete compatibility template',
                'mass-success' => 'Selected compatibility templates deleted successfully',
            ],
        ],

        'constructor-templates' => [
            'index' => [
                'title'      => 'Constructor Group Templates',
                'create-btn' => 'Create Template',
            ...
            'create' => [
                ...
                'checked-once'            => 'Only one product',
                'checked-multiple'        => 'Multiple products',
                'quantity-min'            => 'Minimum Quantity',
                'quantity-max'            => 'Maximum Quantity',
                'sort'                    => 'Sort Order',
                'incompatibility-template' => 'Incompatibility Template',
                'select-template'         => 'Select template...',
                'show-title'              => 'Show group title',
                'opened-by-default'       => 'Group opened by default',
                'zero-price'              => 'All group products at zero price',
                ...
                'no-products'             => 'No products added yet',
                'default'                 => 'Default',
                'product-exists'          => 'This product is already added',
                'success'                 => 'Constructor group template created successfully',
            ],
            ...
            'edit' => [
                ...
                'default'                  => 'Default',
                'product-exists'           => 'This product is already added',
                'success'                  => 'Constructor group template updated successfully',
            ],

            'delete' => [
                'success'      => 'Constructor group template deleted successfully',
                'error'        => 'Cannot delete constructor group template',
                'success-mass' => 'Selected templates deleted successfully',
            ],
        ],
