    ...
    'settings' => [
        ...
        'registration-notifications' => [
            'index' => [
                ...
                'new-registration-emails-label'     => 'Emails for completed registration notifications',
                'new-registration-emails-placeholder' => 'Enter email addresses separated by commas (e.g. notify@example.com)',
                'new-registration-emails-help'      => 'These addresses will receive notifications about new registrations after successful payment via external system.',
