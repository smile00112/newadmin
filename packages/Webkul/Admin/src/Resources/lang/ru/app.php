...
return [
    ...
    'sales' => [
        'orders' => [
            ...
            'view' => [
                ...
                'order-labels'                       => 'Метки заказа',
                'order-status'                       => 'Статус заказа',
                'rating'                             => 'Рейтинг',
                'rating-like'                        => 'Нравится',
                'rating-dislike'                     => 'Не нравится',
                'rating-not-rated'                   => 'Без оценки',
                ...
                'status-history-by'                  => 'Кем: :user',
                'status-history-initial'             => 'Начальный статус',
                'status-history-admin'               => 'Администратор',
                'status-history-customer'            => 'Клиент',
                'status-history-source-system'       => 'Система',
                'status-history-source-api'          => 'API',
                'sub-total'                          => 'Подитог - :sub_total',
                ...
                'table-not-set'                      => 'Не указан',
                'bind-table'                         => 'Привязать',
                'unbind-table'                       => 'Отвязать',
    ...
    'catalog' => [
        'products' => [
            ...
            'edit' => [
                ...
                'links' => [
                    ...
                    'cross-sells' => [
                        'empty-info' => 'Добавьте кросс-продажи.',
                    ...
                    'drinks' => [
                        'empty-info'    => 'Добавьте напитки к блюду.',
                        'info'          => 'Напитки, которые дополняют блюдо и могут быть выбраны по умолчанию.',
                        'title'         => 'Напитки к блюду',
                        'sort'          => 'Сортировка',
                        'default'       => 'По умолчанию',
                        'default-label' => 'Выбрать по умолчанию',
                    ],

                    'ingredients_incompatibility' => [
                        'empty-info' => 'Добавьте несовместимые ингредиенты.',
                        'info'       => 'Ингридиены, которые не совместимы между собой (напр. рыба и молоко).',
                        'title'      => 'Несовместимые ингредиенты',
                    ],

                    'half_portion' => [
                        'title'  => 'Половина порции',
                        'info'   => 'Ингредиент является половиной порции и связан с другим ингредиентом.',
                        'toggle' => 'Половина порции',
                        'select' => 'Связанный ингредиент',
                        'empty'  => 'Выберите связанный ингредиент (половинку порции).',
                    ],
                ...
                'types' => [
                    ...
                    'constructor' => [
                        'add-btn'                     => 'Добавить конструктор',
                        'cancel-btn'                  => 'Отмена',
                        'checked-type'                => 'Тип выбора',
                        'checked-type-multiple'       => 'Несколько',
                        'checked-type-once'           => 'Один',
                        'combo'                       => 'Комбо',
                        'constructor-title'           => 'Конструктор',
                        'create-constructor'          => 'Создать конструктор',
                        'default'                     => 'Выбран по умолчанию',
                        'delete-btn'                  => 'Удалить',
                        'delete-group-btn'            => 'Удалить группу',
                        'design'                      => 'Дизайн',
                        'design-category'             => 'Категория - товар',
                        'design-line'                 => 'В строку',
                        'design-table'                => 'Таблица',
                        'discount'                    => 'Скидка',
                        'discount-fixed'              => 'Фиксированная',
                        'discount-none'               => 'Нет',
                        'discount-percent'            => 'Процентная',
                        'discount-type'               => 'Тип скидки',
                        'discount-value'              => 'Размер скидки',
                        'edit-btn'                    => 'Редактировать',
                        'edit-constructor'            => 'Редактировать конструктор',
                        'edit-group-btn'              => 'Редактировать группу',
                        'empty-info'                  => 'Создание опций конструктора продукта.',
                        'empty-title'                 => 'Добавить конструктор',
                        'field-type'                  => 'Тип поля',
                        'field-type-checkbox'         => 'Несколько вариантов',
                        'field-type-list'             => 'Список',
                        'field-type-radio'            => 'Один вариант',
                        'from-template'               => 'Из шаблона',
                        'select-template'             => 'Выберите шаблон',
                        'template-loaded'             => 'Данные из шаблона загружены',
                        'save-as-template'            => 'Сохранить как шаблон',
                        'template-saved-successfully' => 'Шаблон успешно сохранён',
                        'template-name-required'      => 'Укажите название группы',
                        'confirm-delete-product'      => 'Вы уверены, что хотите удалить этот продукт из группы?',
                        'group'                       => 'Группа',
                        'groups'                      => 'Группы',
                        'group-name'                  => 'Название группы',
                        'group-name-placeholder'      => 'Введите название группы',
                        'group-products'              => 'Продукты группы',
                        'hidden'                      => 'Скрытый',
                        'info'                        => 'Продукт-конструктор позволяет клиентам создавать индивидуальные продукты, выбирая из предопределенных групп ингредиентов или компонентов.',
                        'min-selected-sum'            => 'Мин. сумма выбранных',
                        'no-groups'                   => 'Группы еще не добавлены',
                        'no-products'                 => 'Продукты еще не добавлены',
                        'opened-by-default'           => 'Открыта по умолчанию',
                        'products-count'              => 'Количество продуктов',
                        'quantity-max'                => 'Макс. количество',
                        'quantity-min'                => 'Мин. количество',
                        ...
                        'title'                       => 'Опции конструктора',
                        'visible'                     => 'Видимый',
                        'zero-price'                  => 'Нулевая цена',
                        'edit-group'                  => 'Редактировать группу',
                        'delete-group'                => 'Удалить группу',
                        'add-group'                   => 'Добавить группу',
                        'double-portions'             => 'Двойные порции',
                        'half-portions'               => 'Половинчатые порции',
                        'incompatibility-template'    => 'Шаблон несовместимости',
                        'sale-by-sizes'               => 'Продажа по размерам',
                        'portion-sizes'               => 'Размеры порций',
                        'add-portion-size'            => 'Добавить размер',
                        'edit-portion-size'           => 'Редактировать размер',
                        'save-size-btn'               => 'Сохранить размер',
                        'edit-size'                   => 'Редактировать',
                        'delete-size'                 => 'Удалить',
                        'no-portion-sizes'            => 'Размеры порций еще не добавлены',
                        'portion-name'                => 'Имя',
                        'portion-name-required'       => 'Укажите имя размера порции',
                        'portion-quantity'            => 'Количество',
                        'portion-weight'              => 'Вес',
                        'select-template'             => 'Выберите шаблон...',
        ...
        'attributes' => [
            ...
            'create' => [
                ...
                'value-per-locale'      => 'Значение для языка',
                'yes'                   => 'Да',
        ...
        'ingredient-compatibility' => [
            ...
            'create' => [
                'title'       => 'Создать шаблон совместимости',
                'back-btn'    => 'Назад',
                ...
                'description' => 'Описание',
                'active'      => 'Активен',
                'success'     => 'Шаблон совместимости успешно создан',
            ],

            'edit' => [
                'title'                    => 'Редактировать шаблон совместимости',
                'back-btn'                 => 'Назад',
                'save-btn'                 => 'Сохранить шаблон',
                'general'                  => 'Общая информация',
                'name'                     => 'Название шаблона',
                'description'              => 'Описание',
                'active'                   => 'Активен',
                'incompatibilities'        => 'Несовместимости ингредиентов',
                'add-incompatibility'      => 'Добавить несовместимость',
                'parent-ingredient'        => 'Родительский ингредиент',
                'incompatible-ingredient'  => 'Несовместимый ингредиент',
                'incompatible-ingredients' => 'Несовместимые ингредиенты',
                'search-ingredient'        => 'Поиск ингредиента по SKU или названию...',
                'no-incompatibilities'     => 'Несовместимости еще не добавлены',
                'add-product'              => 'Добавить продукт',
                'no-products'              => 'Продукты не добавлены',
                'success'                  => 'Шаблон совместимости успешно обновлен',
            ],

            'delete' => [
                'success'      => 'Шаблон совместимости успешно удален',
                'error'        => 'Не удалось удалить шаблон совместимости',
                'mass-success' => 'Выбранные шаблоны совместимости успешно удалены',
            ],
        ],

        'constructor-templates' => [
            'index' => [
                'title'      => 'Шаблоны групп конструктора',
                'create-btn' => 'Создать шаблон',
                ...
                'datagrid' => [
                    ...
                    'field-type'     => 'Тип поля',
                    'type-checkbox'  => 'Несколько вариантов',
                    'type-radio'     => 'Один вариант',
                    'type-list'      => 'Список',
                    'required'       => 'Обязательный',
                    'yes'            => 'Да',
                    'no'             => 'Нет',
            ...
            'create' => [
                ...
                'type-list'                => 'Список',
                'checked-type'             => 'Тип выбора',
                'checked-once'             => 'Только один продукт',
                'checked-multiple'         => 'Несколько продуктов',
                'quantity-min'             => 'Минимальное количество',
                'quantity-max'             => 'Максимальное количество',
                'sort'                     => 'Сортировка',
                'incompatibility-template' => 'Шаблон несовместимости',
                'select-template'          => 'Выберите шаблон...',
                'show-title'               => 'Показывать заголовок группы',
                'opened-by-default'        => 'Группа открыта по умолчанию',
                'zero-price'               => 'Все продукты группы по нулевой цене',
                'required'                 => 'Обязательный выбор',
                'hidden'                   => 'Группа скрыта',
                'double-portions'          => 'Двойные порции',
                'half-portions'            => 'Половинчатые порции',
                'products-count'           => 'Количество продуктов',
                'add-product'              => 'Добавить продукт',
                'no-products'              => 'Продукты еще не добавлены',
                'default'                  => 'По умолчанию',
                'product-exists'           => 'Этот продукт уже добавлен',
                'success'                  => 'Шаблон группы конструктора успешно создан',
            ],

            'edit' => [
                'title'                    => 'Редактировать шаблон группы',
                'back-btn'                 => 'Назад',
                'save-btn'                 => 'Сохранить шаблон',
                'general'                  => 'Общая информация',
                'options'                  => 'Настройки',
                ...
                'default'                  => 'По умолчанию',
                'product-exists'           => 'Этот продукт уже добавлен',
                'success'                  => 'Шаблон группы конструктора успешно обновлен',
            ],

            'delete' => [
                'success'      => 'Шаблон группы конструктора успешно удален',
                'error'        => 'Не удалось удалить шаблон группы конструктора',
                'success-mass' => 'Выбранные шаблоны успешно удалены',
            ],
        ],
        ...
        'categories' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'update-status'  => 'Обновить статус',
                    'view-products'  => 'Товары категории',
                ],
            ],
        ...
        'families' => [
            ...
            'create' => [
                ...
                'groups'                           => 'Группы',
                'groups-info'                      => 'Управление группами группы атрибутов',
                'main-column'                      => 'Главная колонка',
                'name'                             => 'Название',
                'removal-not-possible'             => 'Вы не можете удалить системные атрибуты из группы атрибутов.',
            ...
            'delete-failed'           => 'Ошибка при удалении группы атрибутов.',
    ...
    'cms' => [
        ...
        'create-success' => 'Инф. страница успешно создана.',
        'delete-success' => 'Инф. страница успешно удалена.',
        'no-resource'    => 'Ресурс не существует.',
        'update-success' => 'Инф. страница успешно обновлена.',
    ],
    'settings' => [
        'locales' => [
            'index' => [
                'create-btn' => 'Создать язык',
                'locale'     => 'Язык',
                ...
                'create' => [
                    'code'             => 'Код',
                    'direction'        => 'Направление',
                    'locale-logo'      => 'Логотип языка',
                    'name'             => 'Название',
                    'save-btn'         => 'Сохранить язык',
                ...
                'create-success'    => 'Язык успешно создана.',
                'delete-failed'     => 'Ошибка при удалении языка',
                'delete-success'    => 'Язык успешно удалена.',
                'delete-warning'    => 'Вы уверены, что хотите выполнить это действие?',
                'last-delete-error' => 'Необходимо хотя бы одну язык.',
                'update-success'    => 'Язык успешно обновлена.',
            ],
        ],

        'product_category_positions' => [
            'title'           => 'Привязка товаров к категориям',
            'description'     => 'Привяжите товары к дополнительным категориям и установите параметр показа (вверху, по середине, внизу или позиция числом).',
            'table-hint'      => 'Добавьте привязки товар-категория с указанием позиции отображения.',
            'product'         => 'Товар',
            'category'        => 'Категория',
            'position_type'   => 'Позиция',
            'position_value'  => 'Номер позиции',
            'position_top'    => 'Вверху',
            'position_middle' => 'По середине',
            'position_bottom' => 'Внизу',
            'position_numeric'=> 'Позиция числом',
            'add'             => 'Добавить привязку',
            'select_product'  => 'Выбрать товар',
            'select_category' => 'Выбрать категорию',
            'change'          => 'Изменить',
            'empty-title'     => 'Нет привязок',
            'empty-info'      => 'Добавьте привязки товар-категория для управления позициями отображения.',
        ],
        ...
        'channels' => [
            ...
            'create' => [
                ...
                'currencies'              => 'Валюты',
                'currencies-and-locales'  => 'Валюты и языки',
        ...
        'index'                        => [
            ...
            'general' => [
                ...
                'magic-ai' => [
                    ...
                    'content-generation' => [
                        ...
                        'cms-page-content-prompt'          => 'Подсказка для содержимого инф. страницы',
                        'enabled'                          => 'Включено',
            ...
            'catalog' => [
                ...
                'products' => [
                    ...
                    'cart-view-page' => [
                        ...
                        'separate-cross-sell-list'         => 'Отдельный список cross-sells для корзины',
                        'separate-cross-sell-list-info'    => 'При включении будет использоваться отдельный список товаров для cross-sell в корзине, независимо от настроек товаров',
                        'cart-cross-sell-products'         => 'Товары для cross-sell в корзине',
                        'cart-cross-sell-products-info'    => 'Выберите товары, которые будут отображаться как cross-sell на странице корзины',
                    ],
            ...
            'customer' => [
                ...
                'settings' => [
                    ...
                    'auth-types' => [
                        ...
                        'info'            => '"Типы авторизации" Позволяет пользователю авотризоваться, получив временный код по sms, telegram или whatsapp',
                        'except-numbers'  => [
                            'title'      => 'Номера исключения (для тестов)',
                            'title-info' => 'На эти номера не будет отправлять сообщение. Для входа будет использоваться код "'.config('123').'"',
                        ],

                        'sms' => [
                            'sms-verification'   => 'Разрешить авторизацию по смс',
                            'title'              => 'Авторизация по смс',
                            'title-info'         => 'Колучение кода для входа по смс',
                            'client-id'          => [
                                'title'      => 'Логин смс сервиса',
                                'title-info' => '',
                            ],
                            'client-secret' => [
                                'title'      => 'Пароль смс сервиса',
                                'title-info' => '',
                            ],
                            'message_text' => [
                                'title'      => 'Сообщение, которое получит пользователь в смс при попытке авторизоваться (Если смс его требует)',
                                'title-info' => '',
                            ],
                        ],

                        'telegram' => [
                            'telegram-verification' => 'Разрешить авторизацию по telegram',
                            'title'                 => 'Авторизация по telegram',
                            'title-info'            => 'Колучение кода для входа по telegram',
                            'api-key'               => [
                                'title'      => 'API ключ телеграм',
                                'title-info' => 'Чтобы получить ключа бота, перейдите в @BotFather и создайте новый бот. Затем скопируйте токен.',
                            ],
                            'bot-url' => [
                                'title'      => 'Ссылка на бота',
                                'title-info' => 'Чтобы получить ссылку на бота, перейдите в @BotFather и создайте новый бот. Затем скопируйте ссылку на бота.',
                            ],
                            'app-site-url' => [
                                'title'      => 'Ссылка на версию сайта для телеграма',
                                'title-info' => 'Запросите у администратора платформы',
                            ],

                        ],
                        'whatsapp' => [
                            'whatsapp-verification' => 'Разрешить авторизацию по whatsapp',
                            'title'                 => 'Авторизация по whatsapp',
                            'title-info'            => 'мы используем платформу green-api.com, необходимо иметь там аккаунт',

                            'service-api-url' => [
                                'title'      => 'Ссылка на сервис whatsapp',
                                'title-info' => 'можно получить, зарегистрировав аккаунт на платформе green-api.com',
                            ],
                            'id-instance' => [
                                'title'      => 'ID подключения',
                                'title-info' => 'можно получить, зарегистрировав аккаунт на платформе green-api.com ',
                            ],
                            'token' => [
                                'title'      => 'Токен',
            ...
            'sales' => [
                ...
                'shipping-methods' => [
                    ...
                    'pickup-shipping' => [
                        'description' => 'Описание',
                        'page-title'  => 'Самовывоз',
                        'status'      => 'Статус',
                        'title'       => 'Название',
                        'title-info'  => 'Самовывоз позволяет клиентам забрать свои заказы в указанном месте без стоимости доставки.',
                    ],
                    ...
                    'dinein-shipping' => [
                        ...
                        'status'      => 'Статус',
                        'title'       => 'Название',
                        'title-info'  => 'Получение заказа в зале позволяет клиентам оформить заказ и получить его прямо за столиком.',
                    ],
                ...
                'payment-methods' => [
                    ...
                    'alfabank'                       => 'Альфа-Банк',
                    'alfabank-info'                  => 'Оплата банковскими картами через платежный шлюз Альфа-Банка.',
                ...
                'order-settings' => [
                    ...
                    'order-labels' => [
                        'info'              => 'Настройте кастомные метки, которые можно добавлять к заказам. Одна метка на строку.',
                        'labels-list'       => 'Список меток заказа',
                        'labels-list-info'  => 'Введите одну метку на строку. Эти метки будут доступны при создании заказов.',
                        'title'             => 'Метки заказа',
                    ],
