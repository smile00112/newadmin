        ...
        'index' => [
            ...
            'sales' => [
                ...
                'order-settings' => [
                    ...
                    'order-statuses' => [
                        'info'                      => 'Настройте статусы заказов для фильтрации в API (активные, завершенные, отмененные).',
                        'title'                     => 'Статусы заказов для API',
                        'active-statuses'            => 'Статусы активных заказов',
                        'active-statuses-info'       => 'Выберите статусы, которые считаются активными заказами. Эти статусы будут использоваться в API /api/v1/customer/active-orders',
                        'completed-statuses'         => 'Статусы завершенных заказов',
                        'completed-statuses-info'    => 'Выберите статусы, которые считаются завершенными заказами. Эти статусы будут использоваться в API /api/v1/customer/completed-orders',
                        'cancelled-statuses'         => 'Статусы отмененных заказов',
                        'cancelled-statuses-info'    => 'Выберите статусы, которые считаются отмененными заказами. Эти статусы будут использоваться в API /api/v1/customer/cancelled-orders',
                        'preparing'                  => 'Готовится',
                        'ready'                      => 'Готов',
                        'completed'                  => 'Завершен',
                        'closed'                     => 'Закрыт',
