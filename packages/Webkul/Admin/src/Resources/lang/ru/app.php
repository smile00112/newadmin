...
return [
    ...
    'settings' => [
        ...
        'registration-notifications' => [
            'update-success'   => 'Настройки успешно обновлены.',
            ...
            'index' => [
                ...
                'payment-company-label'    => 'Компания для оплаты при регистрации',
                'payment-company-placeholder' => 'Выберите компанию',
                'payment-company-help'     => 'Выберите компанию, чьи платёжные настройки (Tochka) будут использоваться при оплате с формы регистрации. Если не выбрано — используются настройки по умолчанию.',
                'payment-company-empty'    => 'Не выбрано (настройки по умолчанию)',
