...
return [
    ...
    'settings' => [
        ...
        'pickup-points' => [
            ...
            'add-btn' => 'Добавить точку самовывоза',
            'edit-btn' => 'Редактировать',
            'delete-btn' => 'Удалить',
            'cancel-btn' => 'Отмена',
            'save-btn' => 'Сохранить',
            ...
            'map-icon' => 'Иконка для карты',
            'create' => [
                'title' => 'Создать точку самовывоза',
            ],
            'edit' => [
                'title' => 'Редактировать точку самовывоза',
            ],
            'empty-state' => [
                'title' => 'Нет точек самовывоза',
                'description' => 'Добавьте точки самовывоза для этого склада',
            ],
            'create-success' => 'Точка самовывоза успешно создана',
            'update-success' => 'Точка самовывоза успешно обновлена',
            'delete-success' => 'Точка самовывоза успешно удалена',
            'delete-failed' => 'Ошибка при удалении точки самовывоза',
            'delete-confirm' => 'Вы уверены, что хотите удалить эту точку самовывоза?',
            'save-failed' => 'Ошибка при сохранении точки самовывоза',
        ],
