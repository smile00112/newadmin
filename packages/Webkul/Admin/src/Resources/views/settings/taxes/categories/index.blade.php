    ...
    <v-tax-categories>
        <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
            <div class="flex items-center gap-3">
                <div class="flex items-center justify-center w-11 h-11 rounded-xl" style="background: linear-gradient(135deg, #f97316 0%, #ea580c 100%); box-shadow: 0 4px 15px rgba(249,115,22,0.3); min-width:44px;">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400">Налоговые категории</p>
                </div>
            </div>
            ...
            app.component('v-tax-categories', {
                ...
                methods: {
                    openDrawer(mode, record = null) {
                        ...
                        if (mode === 'create') {
                            targetUrl = window.location.origin + '/admin/settings/taxes/categories/create-panel';
                            targetId = 'create';
                        } else {
                            targetUrl = window.location.origin + '/admin/settings/taxes/categories/edit-panel/' + record.id;
                            targetId = record.id;
                        }
                    ...
                    preloadRecord(record) {
                        ...
                        this.hoverTimer = setTimeout(() => {
                            ...
                            this.isDrawerLoading = true;
                            this.iframeSrc = window.location.origin + '/admin/settings/taxes/categories/edit-panel/' + record.id;
                        }, 150);
                    },
