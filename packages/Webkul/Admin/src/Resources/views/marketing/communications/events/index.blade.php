        ...
        <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400">События</p>
                </div>
            </div>
            ...
            app.component('v-events', {
                ...
                methods: {
                    openDrawer(mode, record = null) {
                        ...
                        if (mode === 'create') {
                            targetUrl = window.location.origin + '/admin/marketing/communications/events/create-panel';
                            targetId = 'create';
                        } else {
                            targetUrl = window.location.origin + '/admin/marketing/communications/events/edit-panel/' + record.id;
                            targetId = record.id;
                        }
                    ...
                    preloadRecord(record) {
                        ...
                        this.hoverTimer = setTimeout(() => {
                            ...
                            this.isDrawerLoading = true;
                            this.iframeSrc = window.location.origin + '/admin/marketing/communications/events/edit-panel/' + record.id;
                        }, 150);
                    },
