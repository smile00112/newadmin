...
return [
    ...
    */
    ...
    [
        ...
        'key'    => 'sales.payment_methods.alfabank',
        'name'   => 'admin::app.configuration.index.sales.payment-methods.alfabank',
        'info'   => 'admin::app.configuration.index.sales.payment-methods.alfabank-info',
        'sort'   => 5,
        'fields' => [
            [
                'name'          => 'title',
