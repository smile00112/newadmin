<!-- Channel Lists Stats Vue Component for Dashboard -->
<v-dashboard-channel-lists-stats channel-type="{{ $channelType }}" channel-label="{{ $channelLabel }}">
    <!-- Shimmer -->
...
</v-dashboard-channel-lists-stats>

@pushOnce('scripts')
    <script
        type="text/x-template"
        id="v-dashboard-channel-lists-stats-template"
    >
        <!-- Shimmer -->
    ...
    <script type="module">
        app.component('v-dashboard-channel-lists-stats', {
            template: '#v-dashboard-channel-lists-stats-template',
