        ...
        <div class="mt-4">
            <div class="grid grid-cols-1 gap-4">
                <div class="control-group">
                    ...
                    <input type="text" name="name" id="name" class="control" value="{{ old('name', $company->name) }}" required>
                    @error('name')
                ...
                <div class="control-group">
                    ...
                    <input type="text" name="slug" id="slug" class="control" value="{{ old('slug', $company->slug) }}" placeholder="{{ __('newsletters::app.admin.companies.slug-placeholder') }}">
                ...
                <div class="control-group">
                    ...
                    <textarea name="description" id="description" class="control" rows="4">{{ old('description', $company->description) }}</textarea>
                    @error('description')
                        <span class="text-red-600">{{ $message }}</span>
                    @enderror
                </div>
