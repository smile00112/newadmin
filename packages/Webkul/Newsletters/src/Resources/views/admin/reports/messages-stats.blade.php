<!-- Messages Stats Vue Component -->
<v-reports-messages-stats>
    <!-- Shimmer -->
...
@pushOnce('scripts')
    <script
        ...
        id="v-reports-messages-stats-template"
    >
        <!-- Shimmer -->
                ...
                <div class="flex justify-between gap-2">
                    <div class="flex flex-col justify-between gap-1">
                        <p class="text-base font-semibold text-gray-600 dark:text-gray-300">
                            @lang('newsletters::app.admin.reports.messages-stats.title')
                        </p>
                    </div>
    ...
    <script type="module">
        app.component('v-reports-messages-stats', {
            template: '#v-reports-messages-stats-template',
