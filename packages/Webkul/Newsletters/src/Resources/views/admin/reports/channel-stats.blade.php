<!-- Channel Stats Vue Component -->
<v-reports-channel-stats channel-type="{{ $channelType }}" channel-label="{{ $channelLabel }}">
    <!-- Shimmer -->
...
</v-reports-channel-stats>

@pushOnce('scripts')
    <script
        type="text/x-template"
        id="v-reports-channel-stats-template"
    >
        <!-- Shimmer -->
    ...
    <script type="module">
        app.component('v-reports-channel-stats', {
            template: '#v-reports-channel-stats-template',
