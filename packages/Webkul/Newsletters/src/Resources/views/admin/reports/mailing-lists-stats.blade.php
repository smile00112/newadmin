<!-- Mailing Lists Stats Vue Component -->
<v-reports-mailing-lists-stats>
    <!-- Shimmer -->
...
@pushOnce('scripts')
    <script
        ...
        id="v-reports-mailing-lists-stats-template"
    >
        <!-- Shimmer -->
        ...
        <!-- Mailing Lists Stats Section -->
        <template v-else>
            <div class="grid gap-4 px-4 py-4 dark:border-gray-800">
                <div class="flex justify-between gap-2">
                    <div class="flex flex-col justify-between gap-1">
                        <p class="text-base font-semibold text-gray-600 dark:text-gray-300">
                            @lang('newsletters::app.admin.reports.mailing-lists-stats.title')
                        </p>
                    </div>
    ...
    <script type="module">
        app.component('v-reports-mailing-lists-stats', {
            template: '#v-reports-mailing-lists-stats-template',
            ...
            computed: {
                ...
                chartDatasets() {
                    ...
                    return [{
                        label: '@lang("newsletters::app.admin.reports.mailing-lists-stats.title")',
