...
<head>
    ...
    <title>Политика конфиденциальности - MailingService</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        ...
        <p>Настоящая политика конфиденциальности описывает, как MailingService собирает, использует и защищает персональные данные пользователей.</p>
