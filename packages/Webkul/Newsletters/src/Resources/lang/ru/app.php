...
return [
    'admin' => [
        ...
        'mailing-lists' => [
            ...
            'message-delay-from' => 'Минимальная задержка между сообщениями (сек)',
            'message-delay-from-hint' => 'Минимальная задержка между сообщениями в секундах (1-3600)',
            'message-delay-to' => 'Максимальная задержка между сообщениями (сек)',
            'message-delay-to-hint' => 'Максимальная задержка между сообщениями в секундах (1-3600)',
            'max-messages-per-instance' => 'Максимальное количество сообщений для инстанса',
            'max-messages-per-instance-hint' => 'Максимальное количество сообщений, которое может отправить один инстанс',
