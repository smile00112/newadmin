...
return [
    'admin' => [
        ...
        'account-warmings' => [
            ...
            'phrases' => 'Фразы для диалога',
            'question' => 'Вопрос',
            'answer' => 'Ответ',
            'add-phrase-pair' => 'Добавить пару фраз',
            'min-phrases-required' => 'Необходима хотя бы одна пара фраз',
            'delay-from' => 'Задержка от (сек)',
            'delay-to' => 'Задержка до (сек)',
            'delay-hint' => 'Задержка между сообщениями в секундах (1-3600)',
            'start-at' => 'Начать с',
            'active' => 'Активен',
            'is-active' => 'Активен',
            'not-active' => 'Не активен',
            'inactive' => 'Неактивен',
            'accounts-count' => 'Количество аккаунтов',
            'created' => 'Прогрев успешно создан.',
            'updated' => 'Прогрев успешно обновлен.',
            'deleted' => 'Прогрев успешно удален.',
            'create-failed' => 'Не удалось создать прогрев.',
            'update-failed' => 'Не удалось обновить прогрев.',
            'delete-failed' => 'Не удалось удалить прогрев.',
            'delete-confirm' => 'Вы уверены, что хотите удалить этот прогрев?',
            'no-warmings' => 'Прогревы не найдены.',
            'start-warming' => 'Запустить прогрев',
            'pause-warming' => 'Приостановить прогрев',
            'start-confirm' => 'Вы уверены, что хотите запустить этот прогрев?',
            'pause-confirm' => 'Вы уверены, что хотите приостановить этот прогрев?',
            'warming-started' => 'Прогрев успешно запущен.',
            'warming-start-failed' => 'Не удалось запустить прогрев.',
            'warming-paused' => 'Прогрев успешно приостановлен.',
            'warming-pause-failed' => 'Не удалось приостановить прогрев.',
            'min-accounts-required' => 'Необходимо выбрать минимум 2 аккаунта.',
            'insufficient-active-accounts' => 'Недостаточно активных аккаунтов (минимум 2).',
            'no-phrases' => 'Необходимо добавить хотя бы одну пару фраз.',
            'invalid-phrases' => 'Все пары фраз должны содержать вопрос и ответ.',
            'cannot-edit-active' => 'Нельзя редактировать активный прогрев. Сначала приостановите его.',
            'cannot-delete-active' => 'Нельзя удалить активный прогрев. Сначала приостановите его.',
            'status' => [
                'created' => 'Создан',
                'pending' => 'В ожидании',
                'running' => 'Выполняется',
        ...
        'contacts' => [
            ...
            'duplicate-phone' => 'Контакт с таким номером телефона уже существует в этой группе.',
        ],
