...
class ContactFilterRepository extends Repository
{
    ...
    function model()
    {
        return 'Webkul\Newsletters\Models\NewslettersContactFilter';
    }
    ...
    /**
     * Get filters for a specific contact group.
     */
    public function getByGroupId(int $groupId)
    {
        ...
        $result = $this->model->where('contact_group_id', $groupId)->get();
        $this->resetModel();
        $this->resetScope();
