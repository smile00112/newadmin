...
return [
    'apple-live-activity' => [
        ...
        'fields' => [
            ...
            'rate-order-delay'      => 'Rate Order Delay (minutes)',
            'rate-order-delay-info' => 'Minutes after "Ready" before sending the rate-order prompt to the Live Activity',
            'close-delay'           => 'Close Delay (minutes)',
            'close-delay-info'      => 'Minutes after "Ready" before closing the Live Activity (only if order has not been rated)',
        ],
    ],
