...
return [
    'apple-live-activity' => [
        ...
        'fields' => [
            ...
            'rate-order-delay'      => 'Задержка запроса оценки (мин)',
            'rate-order-delay-info' => 'Через сколько минут после статуса «Готов» отправить запрос оценки в Live Activity',
            'close-delay'           => 'Задержка закрытия (мин)',
            'close-delay-info'      => 'Через сколько минут после статуса «Готов» закрыть Live Activity (только если заказ не оценён)',
        ],
    ],
