    ...
    <x-admin::form :action="route('admin.bonus.levels.update', $level->id)" method="PUT">
        ...
        <div class="mt-7 box-shadow rounded bg-white p-4 dark:bg-gray-900">
            ...
            <x-admin::form.control-group>
                ...
                <x-admin::form.control-group.control type="number" name="cashback_percent" :value="old('cashback_percent', $level->cashback_percent)" rules="required|integer" />
            </x-admin::form.control-group>
            ...
            <x-admin::form.control-group>
                ...
                <x-admin::form.control-group.control type="number" name="threshold_value" :value="old('threshold_value', $level->threshold_value)" rules="required|integer" />
            </x-admin::form.control-group>
