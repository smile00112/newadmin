        ...
        'fields' => [
            ...
            [
               ...
               // 'default'       => [Order::STATUS_COMPLETED],
                'channel_based' => true,
                'options'       => [
                    ['title' => Order::STATUS_PENDING, 'value' => Order::STATUS_PENDING],
                    ['title' => Order::STATUS_PENDING_PAYMENT, 'value' => Order::STATUS_PENDING_PAYMENT],
                    ['title' => Order::STATUS_PROCESSING, 'value' => Order::STATUS_PROCESSING],
                    ['title' => Order::STATUS_PREPARING, 'value' => Order::STATUS_PREPARING],
                    ['title' => Order::STATUS_READY, 'value' => Order::STATUS_READY],
                    ['title' => Order::STATUS_COMPLETED, 'value' => Order::STATUS_COMPLETED],
                    ['title' => Order::STATUS_CANCELED, 'value' => Order::STATUS_CANCELED],
                    ['title' => Order::STATUS_CLOSED, 'value' => Order::STATUS_CLOSED],
                    ['title' => Order::STATUS_FRAUD, 'value' => Order::STATUS_FRAUD],
                ],
            ],
            [
