    ...
    [
        ...
        'fields' => [
            ...
            [
                ...
                'channel_based' => true,
                'options'       => [
                    ['title' => 'bonus::app.admin.settings.order-status.pending', 'value' => Order::STATUS_PENDING],
                    ['title' => 'bonus::app.admin.settings.order-status.pending_payment', 'value' => Order::STATUS_PENDING_PAYMENT],
                    ['title' => 'bonus::app.admin.settings.order-status.processing', 'value' => Order::STATUS_PROCESSING],
                    ['title' => 'bonus::app.admin.settings.order-status.preparing', 'value' => Order::STATUS_PREPARING],
                    ['title' => 'bonus::app.admin.settings.order-status.ready', 'value' => Order::STATUS_READY],
                    ['title' => 'bonus::app.admin.settings.order-status.completed', 'value' => Order::STATUS_COMPLETED],
                    ['title' => 'bonus::app.admin.settings.order-status.canceled', 'value' => Order::STATUS_CANCELED],
                    ['title' => 'bonus::app.admin.settings.order-status.closed', 'value' => Order::STATUS_CLOSED],
                    ['title' => 'bonus::app.admin.settings.order-status.fraud', 'value' => Order::STATUS_FRAUD],
                ],
            ],
            [
