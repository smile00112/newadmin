...
use Webkul\TochkaPayment\Contracts\TochkaPaymentWebhook as TochkaPaymentWebhookContract;

class TochkaPaymentWebhook extends Model implements TochkaPaymentWebhookContract
{
