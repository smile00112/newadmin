    ...
    'admin' => [
        ...
        'systems' => [
            ...
            'create' => [
                ...
                'woocommerce_consumer_key_help'  => 'Consumer Key from WooCommerce → Settings → Advanced → REST API. Required for updating order status.',
                'woocommerce_consumer_secret'    => 'WooCommerce Consumer Secret',
                'woocommerce_consumer_secret_help' => 'Consumer Secret from WooCommerce REST API. Leave empty when editing to keep current value.',
                'is_active'       => 'Active',
            ...
            'edit' => [
                ...
                'woocommerce_consumer_secret_placeholder' => 'Leave empty to keep current value',
