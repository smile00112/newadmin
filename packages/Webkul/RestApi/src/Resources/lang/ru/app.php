        ...
        'sales' => [
            'orders' => [
                ...
                'error' => [
                    ...
                    'invalid-payment-method'          => 'Для этого заказа недоступно подтверждение оплаты через Альфа-Банк.',
                    'invalid-status-for-payment'      => 'Оплата не может быть подтверждена для заказа в текущем статусе.',
                    'payment-not-confirmed'           => 'Оплата не подтверждена шлюзом.',
                    'payment-processing-failed'       => 'Ошибка обработки подтверждения оплаты. Попробуйте позже.',
                ],
            ],
        ],
